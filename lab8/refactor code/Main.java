...
public class Main {
    public static void main (String[] args) {
        ...
        C1.addRental(new Rental(null, new DataRange(start, end1)));
        C1.addRental(new Rental(null, new DataRange(start, end2)));
        C1.addRental(new Rental(null, new DataRange(start, end3)));
        ...
        C2.addRental(new Rental(null, new DataRange(start, end1)));
        C2.addRental(new Rental(null, new DataRange(start, end2)));
        ...
        C3.addRental(new Rental(null, new DataRange(start, end1)));
        C3.addRental(new Rental(null, new DataRange(start, end2)));
